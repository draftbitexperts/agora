...
const P1Week7CoachesCornerScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* Fetch 2 */}
            <PerformApi.FetchGetCoachCornerVideoGET week={7}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {
                '! Welcome to the seventh week of the Primal Foundation Course. This week, we’ll focus on building endurance and fine-tuning your nutrition strategy. Be sure to watch the Coaches’ Corner video for essential tips and motivation to help you push through to the finish line.'
              }
            </Text>
          </View>
        </View>
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1BodyweightWorkoutWeek7Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltesttwo(false);
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1WeightedWorkoutWeek7Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltestthree(false);
...
export default withTheme(P1Week7CoachesCornerScreen);
