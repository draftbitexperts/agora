...
const P1WeightedWorkoutWeek4Layout2Screen = props => {
  const { theme } = props;
  ...
  const [data, setData] = React.useState([
    {
      ...
      equipments: [
        ...
        { name: 'Slam Ball', imageName: 'slamballicon' },
        { name: 'Skier', imageName: 'skiericon' },
      ],
      singleRounds: 'RPE 7',
    },
    {
      id: '2',
      title: 'Deadlift/Squat Press',
      action: 'Foundation',
      videoId: '1033249835',
      duration: 20,
      equipments: [
    ...
    },
    {
      ...
      equipments: [
        ...
        { name: 'Barbell', imageName: 'barbbellicon' },
        { name: 'Kettlebell', imageName: 'kettlebellicon' },
        { name: 'Med Ball', imageName: 'slamballicon' },
        { name: 'Skier', imageName: 'skiericon' },
      ],
      singleRounds: 'RPE 7',
    },
...
export default withTheme(P1WeightedWorkoutWeek4Layout2Screen);
