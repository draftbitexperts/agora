...
const defaultProps = { Bicycle: null };

const P1BodyweightWorkoutWeek8Layout2Screen = props => {
  const { theme } = props;
...
export default withTheme(P1BodyweightWorkoutWeek8Layout2Screen);
