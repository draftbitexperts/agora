...
const P1Week3CoachesCornerScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* Fetch 2 */}
            <PerformApi.FetchGetCoachCornerVideoGET week={3}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {
                '! Welcome to the third week of the Primal Foundation Course. This week, we’ll continue to build on your progress with updated workouts and nutrition guidance. Don’t forget to watch the Coaches’ Corner video for valuable insights and tips.'
              }
            </Text>
          </View>
        </View>
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1BodyweightWorkoutWeek3Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltesttwo(false);
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1WeightedWorkoutWeek3Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltestthree(false);
...
export default withTheme(P1Week3CoachesCornerScreen);
