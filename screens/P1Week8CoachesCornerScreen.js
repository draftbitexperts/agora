...
const P1Week8CoachesCornerScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* Fetch 2 */}
            <PerformApi.FetchGetCoachCornerVideoGET week={8}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {
                '! Welcome to the eighth and final week of the Primal Foundation Course. This week, we’ll consolidate everything you’ve learned with comprehensive workouts and final nutrition advice to set you up for long-term success. Don’t forget to watch the Coaches’ Corner video for closing insights and encouragement as you complete the course. Congratulations on making it this far!'
              }
            </Text>
          </View>
        </View>
        {/* Nutrition Bodyweight Workout Weighted Workout Container View */}
        <View
          style={StyleSheet.applyWidth(
            {
        ...
        >
          ...
          >
            ...
            {/* Bodyweight Workout Weighted Workout View */}
            <View
              style={StyleSheet.applyWidth(
                {
                  backgroundColor: 'rgba(0, 0, 0, 0)',
        ...
        {/* Message and Scan Me Container View */}
        <View
          style={StyleSheet.applyWidth(
                  ...
                  style={StyleSheet.applyWidth(
                    {
                      ...
                      paddingTop: [
                        { minWidth: Breakpoints.Mobile, value: 16 },
                        {
                          ...
                          value: dimensions.width > dimensions.height ? 30 : 10,
                        },
                      ],
                    },
                    dimensions.width
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1BodyweightWorkoutWeek8Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltesttwo(false);
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1WeightedWorkoutWeek8Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltestthree(false);
...
export default withTheme(P1Week8CoachesCornerScreen);
