...
const P1WeightedWorkoutWeek6Layout2Screen = props => {
  const { theme } = props;
  ...
  const [data, setData] = React.useState([
    {
      ...
      duration: 20,
      equipments: [
        { name: 'Kettlebell', imageName: 'kettlebellicon' },
        { name: 'Dumbbell', imageName: 'dumbbell' },
        { name: 'Jump Box', imageName: 'jumpbox' },
        { name: 'Barbell', imageName: 'barbbellicon' },
    ...
    },
    {
      ...
      equipments: [
        { name: 'Kettlebell', imageName: 'kettlebellicon' },
        { name: 'Dumbbelll', imageName: 'dumbbell' },
        { name: 'Jump Box', imageName: 'jumpbox' },
        { name: 'Barbell', imageName: 'barbbellicon' },
        { name: 'Bodyweight', imageName: 'bodyweighticon' },
      ],
  ...
  const scrollViewExerciseContainerViewSwiperContainerViewStopwatch2SRef =
    React.useRef();
          ...
          >
            ...
            >
              ...
              <Timer
                ...
                initialTime={0}
                ref={
                  scrollViewExerciseContainerViewSwiperContainerViewStopwatch2SRef
                }
                style={StyleSheet.applyWidth(
                  StyleSheet.compose(
              ...
              >
                      ...
                      <Touchable
                        onPress={() => {
                          try {
                            ...
                            scrollViewExerciseContainerViewSwiperContainerViewStopwatch2SRef.current?.stop();
                          } catch (err) {
                            console.error(err);
                          }
                        }}
                      ...
                      <Touchable
                        onPress={() => {
                          try {
                            ...
                            scrollViewExerciseContainerViewSwiperContainerViewStopwatch2SRef.current?.start();
                          } catch (err) {
                            console.error(err);
                          }
                        }}
                ...
                >
                  ...
                  <Touchable
                    onPress={() => {
                      try {
                        scrollViewExerciseContainerViewSwiperContainerViewStopwatch2SRef.current?.reset(
                          0
                        );
...
export default withTheme(P1WeightedWorkoutWeek6Layout2Screen);
