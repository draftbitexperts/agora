...
const P1WeightedWorkoutWeek3Layout2Screen = props => {
  const { theme } = props;
  ...
  const [data, setData] = React.useState([
    {
      ...
      equipments: [
        ...
        { name: 'Air Bike', imageName: 'airbikeicon' },
      ],
      singleRounds: 'RPE 7',
    },
    {
...
export default withTheme(P1WeightedWorkoutWeek3Layout2Screen);
