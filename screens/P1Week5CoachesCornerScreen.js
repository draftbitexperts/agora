...
const P1Week5CoachesCornerScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* Fetch 2 */}
            <PerformApi.FetchGetCoachCornerVideoGET week={5}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {
                '! Welcome to the fifth week of the Primal Foundation Course. This week, we’re focusing on refining your techniques and enhancing your nutrition plan. Be sure to watch the Coaches’ Corner video to gain valuable insights and stay motivated on your journey.'
              }
            </Text>
          </View>
        </View>
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1BodyweightWorkoutWeek5Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltesttwo(false);
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1WeightedWorkoutWeek5Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltestthree(false);
...
export default withTheme(P1Week5CoachesCornerScreen);
