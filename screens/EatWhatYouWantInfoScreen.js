...
const EatWhatYouWantInfoScreen = props => {
  const { theme } = props;
      ...
      >
          ...
          >
            ...
            >
              ...
              <Image
                ...
                resizeMode={'contain'}
                source={imageSource(Images['option3eatwhatyouwantcoverimage'])}
                style={StyleSheet.applyWidth(
                  StyleSheet.compose(
        ...
        >
          ...
          <Button
            ...
            onPress={() => {
              try {
                navigation.navigate('NutritionScreen', {}, { pop: true });
              } catch (err) {
                console.error(err);
              }
            }}
...
export default withTheme(EatWhatYouWantInfoScreen);
