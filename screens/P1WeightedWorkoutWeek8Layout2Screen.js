...
const P1WeightedWorkoutWeek8Layout2Screen = props => {
  const { theme } = props;
        ...
        >
          ...
          >
            ...
            >
              ...
              <View
                style={StyleSheet.applyWidth(
                  { paddingBottom: 20, paddingLeft: 15, paddingTop: 20 },
                  dimensions.width
                )}
              >
                {/* Todays workout Text 2 */}
                <Text
                  accessible={true}
                  selectable={false}
                  {...GlobalStyles.TextStyles(theme)['Text'].props}
...
export default withTheme(P1WeightedWorkoutWeek8Layout2Screen);
