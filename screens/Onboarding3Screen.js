...
const Onboarding3Screen = props => {
  ...
  return (
    <ScreenContainer hasSafeArea={false} scrollable={false}>
      ...
      <Image
        resizeMode={'cover'}
        source={imageSource(Images['nutritioncoverimage2edited'])}
      ...
      >
        ...
        <View style={StyleSheet.applyWidth({ flex: 1 }, dimensions.width)}>
          ...
          >
            {
              'We build a tough mental attitude to training and help instil healthy eating patterns'
            }
          </Text>
        </View>
        {/* Next Skip View */}
        ...
        >
          ...
          <Touchable
            onPress={() => {
              try {
                navigation.navigate('Onboarding4Screen', {}, { pop: true });
              } catch (err) {
                console.error(err);
              }
            }}
