...
const P1BodyweightWorkoutWeek6Layout2Screen = props => {
  const { theme } = props;
      ...
      >
        ...
        >
          ...
          >
            ...
            <View
              style={StyleSheet.applyWidth(
                { alignItems: 'stretch', marginTop: 16 },
                dimensions.width
              )}
            >
              {/* Background Colour View 1 */}
...
export default withTheme(P1BodyweightWorkoutWeek6Layout2Screen);
