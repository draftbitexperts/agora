...
const P1Week2CoachesCornerScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* Fetch 2 */}
            <PerformApi.FetchGetCoachCornerVideoGET week={2}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {
                '! Welcome to the second week of the Primal Foundation Course. This week, you’ll receive new workouts and nutrition advice, so be sure to watch the Coaches’ Corner video.'
              }
            </Text>
          </View>
        </View>
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1BodyweightWorkoutWeek2Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltesttwo(false);
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1WeightedWorkoutWeek2Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltestthree(false);
...
export default withTheme(P1Week2CoachesCornerScreen);
