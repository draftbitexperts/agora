...
const P1Week6CoachesCornerScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* Fetch 2 */}
            <PerformApi.FetchGetCoachCornerVideoGET week={6}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {
                '! Welcome to the sixth week of the Primal Foundation Course. As we progress, this week will introduce more advanced workouts and even more nutrition tips to optimise your results. Don’t miss the Coaches’ Corner video for expert advice and encouragement to keep you on track.'
              }
            </Text>
          </View>
        </View>
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1BodyweightWorkoutWeek6Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltesttwo(false);
              ...
              >
                ...
                <Button
                  ...
                  onPress={() => {
                    try {
                      navigation.navigate(
                        'P1WeightedWorkoutWeek6Layout2Screen',
                        {},
                        { pop: true }
                      );
                      setOpenModaltestthree(false);
...
export default withTheme(P1Week6CoachesCornerScreen);
