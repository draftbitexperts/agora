...
const Option2MenusScreen = props => {
  const { theme } = props;
      ...
      >
        ...
        >
          ...
          <Touchable
            onPress={() => {
              try {
                navigation.navigate('PdfTheNutritionScreen', {}, { pop: true });
              } catch (err) {
                console.error(err);
              }
            }}
          >
            ...
            >
              {/* Menus Book Cover Image */}
              <Image
                {...GlobalStyles.ImageStyles(theme)['Image'].props}
                resizeMode={'center'}
                source={imageSource(
                  Images['foundationdietoption2themenuscoverimage']
                )}
                style={StyleSheet.applyWidth(
                  StyleSheet.compose(
...
export default withTheme(Option2MenusScreen);
