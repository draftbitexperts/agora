...
const TheCommunityInfoScreen = props => {
  const { theme } = props;
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {'Getting results as a team'}
            </Text>
          </View>
        </View>
        {/* The Community Container View */}
        <View
          style={StyleSheet.applyWidth(
        ...
        >
          ...
          <Touchable
            onPress={() => {
              try {
                navigation.navigate('PdfTheCommunityScreen', {}, { pop: true });
              } catch (err) {
                console.error(err);
              }
            }}
          >
            ...
            {/* The Community Cover Image Container View */}
            <View
              style={StyleSheet.applyWidth(
                {
                  flexDirection: 'row',
            ...
            >
              {/* The Community Book Cover Image */}
              <Image
                {...GlobalStyles.ImageStyles(theme)['Image'].props}
                resizeMode={'center'}
                source={imageSource(Images['thecommunitycoverimage'])}
                style={StyleSheet.applyWidth(
                  StyleSheet.compose(
...
export default withTheme(TheCommunityInfoScreen);
