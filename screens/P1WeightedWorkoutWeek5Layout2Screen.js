...
const P1WeightedWorkoutWeek5Layout2Screen = props => {
  const { theme } = props;
  ...
  const [data, setData] = React.useState([
    {
      ...
      equipments: [
        ...
        { name: 'Plate', imageName: 'weightplateicon' },
...
export default withTheme(P1WeightedWorkoutWeek5Layout2Screen);
